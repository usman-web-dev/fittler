export const FIREBASE_ERROR_MESSAGES: Record<string, string> = {
  ...
  'auth/email-already-exists': 'The email is already used.',
  ...
  'auth/invalid-photo-url': 'The provided value for the img user property is invalid. It must be a string URL.',
